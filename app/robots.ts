...
export default function robots(): MetadataRoute.Robots {
  return {
    rules: [
      {
        userAgent: '*',
        allow: ['/', '/intelligence', '/network', '/about', '/map-dashboard', '/regions/', '/search', '/llms.txt', '/llms-full.txt'],
        disallow: ['/admin', '/admin/', '/auth', '/auth/', '/api/', '/dashboard', '/dashboard/'],
      },
      // Allow major search engine bots explicitly
      {
        userAgent: 'Googlebot',
        allow: ['/', '/intelligence', '/network', '/about', '/map-dashboard', '/regions/', '/search', '/llms.txt'],
